    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950/30 to-slate-950 flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1">Plan your perfect journey with AI</p>
        </div>
            ...
            <div className="flex items-start gap-3 mt-4 mb-2">
              <div className="flex items-center h-5">
                <input
                  ...
                  className="w-4 h-4 rounded border-slate-600 bg-white/5 text-indigo-500 focus:ring-indigo-500/50 focus:ring-offset-slate-900 transition-colors cursor-pointer"
                />
              </div>
              <label htmlFor="terms" className="text-sm text-slate-400 cursor-pointer">
                I agree to the <Link href="#" className="text-indigo-400 hover:text-indigo-300 transition-colors">Terms of Service</Link> and <Link href="#" className="text-indigo-400 hover:text-indigo-300 transition-colors">Privacy Policy</Link>
              </label>
            </div>
            <button
              type="submit"
